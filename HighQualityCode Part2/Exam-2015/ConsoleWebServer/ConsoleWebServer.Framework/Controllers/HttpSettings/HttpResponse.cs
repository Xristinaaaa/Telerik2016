namespace ConsoleWebServer.Framework.HttpSettings
{
    ...
    public class HttpResponse
    {
        ...
        private const string Hhtp = "HTTP/";
            ...
            string contenttype = ContentType)
        {
            ...
            this.ProtocolVersion = Version.Parse(httpVersion.ToString().ToLower().Replace(Hhtp.ToLower(), string.Empty));
        ...
        public override string ToString()
        {
            ...
            stringBuilder.AppendLine(string.Format("{0}{1} {2} {3}", Hhtp, this.ProtocolVersion, (int)this.StatusCode, this.StatusCodeAsString));
