    ...
    class Solution
    {
        static void Main()
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                for (int j = 0; j < n; j++)
                {
                    matrix[i, j] = byte.Parse(digits[j]);
                }
            }
        ...
        {
            bool containsOnePattern = row >= 0 && row < field.GetLength(0) - 4 && col >= 2 && col < field.GetLength(1) &&
                                      field[row, col] == 1 &&
                                      field[row + 1, col - 1] == 1 &&
                                      field[row + 2, col - 2] == 1 &&
                                      field[row + 1, col] == 1 &&
        ...
        {
            bool containsTwoPattern = row >= 0 && row < field.GetLength(0) - 4 && col >= 1 && col < field.GetLength(1) - 1 &&
                                      field[row, col] == 2 &&
                                      field[row + 1, col - 1] == 2 &&
                                      field[row + 1, col + 1] == 2 &&
                                      field[row + 2, col + 1] == 2 &&
        ...
        {
            bool containsThreePattern = row >= 0 && row < field.GetLength(0) - 4 && col >= 2 && col < field.GetLength(1) &&
                                        field[row, col] == 3 &&
                                        field[row, col - 1] == 3 &&
                                        field[row, col - 2] == 3 &&
                                        field[row + 1, col] == 3 &&
        ...
        {
            bool containsFourPattern = row >= 0 && row < field.GetLength(0) - 4 && col >= 2 && col < field.GetLength(1) &&
                                       field[row, col] == 4 &&
                                       field[row + 1, col] == 4 &&
                                       field[row + 2, col] == 4 &&
                                       field[row + 2, col - 1] == 4 &&
        ...
        {
            bool containsFivePattern = row >= 0 && row < field.GetLength(0) - 4 && col >= 2 && col < field.GetLength(1) &&
                                       field[row, col] == 5 &&
                                       field[row, col - 1] == 5 &&
                                       field[row, col - 2] == 5 &&
                                       field[row + 1, col - 2] == 5 &&
        ...
        {
            bool containsSixPattern = row >= 0 && row < field.GetLength(0) - 4 && col >= 2 && col < field.GetLength(1) &&
                                      field[row, col] == 6 &&
                                      field[row, col - 1] == 6 &&
                                      field[row, col - 2] == 6 &&
                                      field[row + 1, col - 2] == 6 &&
        ...
        {
            bool containsSevenPattern = row >= 0 && row < field.GetLength(0) - 4 && col >= 0 && col < field.GetLength(1) - 2 &&
                                        field[row, col] == 7 &&
                                        field[row, col + 1] == 7 &&
                                        field[row, col + 2] == 7 &&
                                        field[row + 1, col + 2] == 7 &&
        ...
        {
            bool containsEightPattern = row >= 0 && row < field.GetLength(0) - 4 && col >= 0 && col < field.GetLength(1) - 2 &&
                                        field[row, col] == 8 &&
                                        field[row, col + 1] == 8 &&
                                        field[row, col + 2] == 8 &&
                                        field[row + 1, col + 2] == 8 &&
        ...
        {
            bool containsNinePattern = row >= 0 && row < field.GetLength(0) - 4 && col >= 0 && col < field.GetLength(1) - 2 &&
                                       field[row, col] == 9 &&
                                       field[row, col + 1] == 9 &&
                                       field[row, col + 2] == 9 &&
                                       field[row + 1, col + 2] == 9 &&
